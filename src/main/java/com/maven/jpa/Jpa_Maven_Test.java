...
public class Jpa_Maven_Test {
 //declaramos un variable  de tipo entitymanager...
	...
	public static void main(String[] args) {
        ...
        //llamamos al metoddo listar alumno....
        ...
        jpamaven.ActualizarAlumnos(1, "Melany", "Chuquimbalqui", "75847764", "F", "melany@gmail.como");
	...
	//creamos el metodo insertar alumno
		...
		//Creamos el metodo listtar alumnos
		public List<Alumno> ListarAlumnos(){
			//declaramos una variable de tipo string
			String consulta="Select a from Alumno a";
			//aplicamos la interrffaz query
		...
		//creamos eel metoodo actualizar alumnos...
		public void ActualizarAlumnos(int cod,String nom,String ape,String dn,String sex,String em) {
			...
			String cons="UPDATE Alumno a SET a.nombre=:nom,a.apellido=:ape,"
					+ "a.dni=:dn,a.sexo=:sex,a.email=:em where a.idalumno=:cod";
			...
			if(x>0) System.out.println("Datos del alumno actualizado correctamente");
		}
